        ...
        if t == self.rep:
            ...
            if  i == 0:
                 if (self.FiE(j, i) - self.Fi[j, i]) == 0:
                     ...
                     rr = 2 * (self.Fi[j, i] - self.Fi0W) / (self.FiE(j, i) - self.Fi[j, i])  #verified not necessary for i == 1
            elif i == self.Nx - 1:
                 if (self.Fi0E - self.Fi[j, i]) == 0:
                     return 0.0
                 else:
                     rr = (self.Fi[j, i] - self.FiW(j, i)) / (2 * (self.Fi0E - self.Fi[j, i])) #verified
            else:
                 if (self.FiE(j, i) - self.Fi[j, i]) == 0:
                     return 0.0
                 else:
            ...
            if i == 0:
                ...
                if (self.Fi[j, i] - self.FiW(j, i)) == 0:
                    ...
                    rr = 2 * (self.FiW(j, i) - self.Fi0W) / (self.Fi[j, i] - self.FiW(j, i)) # verified
            else:
                if (self.Fi[j, i] - self.FiW(j, i)) == 0:
                    return 0.0
                else:
        ...
        # if u < 0 
            ...
            if i == self.Nx - 1:
                ...
                if (self.FiE(j, i) - self.Fi[j, i]) == 0:
                    ...
                    rr = 2 * (self.Fi0E - self.FiE(j, i)) / (self.FiE(j, i) - self.Fi[j, i]) #verified
            else:
                if (self.FiE(j, i) - self.Fi[j, i]) == 0:
                    return 0.0
                else:
            ...
            #rwm = (FiE - FiP) / (FiP - FiW)
            if i == 0 :
                if (self.Fi[j, i] - self.Fi0W) == 0:
                    return 0
                else:
                    rr = (self.FiE(j, i) - self.Fi[j, i]) / (2 * (self.Fi[j, i] - self.Fi0W)) #verified 
            elif i == self.Nx - 1:
                if (self.Fi[j, i] - self.FiW(j, i)) == 0:
                    return 0.0
                else:
                    rr = 2 * (self.Fi0E - self.Fi[j, i]) / (self.Fi[j, i] - self.FiW(j, i)) #verified
            else:
                if (self.Fi[j, i] - self.FiW(j, i)) == 0:
                    return 0.0
                else:
        ...
        if t == self.rnp:
            ...
            if  j == 0:
                 if (self.FiN(j, i) - self.Fi[j, i]) == 0:
                     ...
                     rr = 2 * (self.Fi[j, i] - self.Fi0S) / (self.FiN(j, i) - self.Fi[j, i])  #verified not necessary for i == 1
            elif j == self.Ny - 1:
                 if (self.Fi0N - self.Fi[j, i]) == 0:
                     return 0.0
                 else:
                     rr = (self.Fi[j, i] - self.FiS(j, i)) / (2 * (self.Fi0N - self.Fi[j, i])) #verified
            else:
                 if (self.FiN(j, i) - self.Fi[j, i]) == 0:
                     return 0.0
                 else:
            ...
            if j == 0:
                ...
                if (self.Fi[j, i] - self.FiS(j, i)) == 0:
                    ...
                    rr = 2 * (self.FiS(j, i) - self.Fi0S) / (self.Fi[j, i] - self.FiS(j, i)) # verified
            else:
                if (self.Fi[j, i] - self.FiS(j, i)) == 0:
                    return 0.0
                else:
        ...
        # if u < 0 
            ...
            if j == self.Ny - 1:
                ...
                if (self.FiN(j, i) - self.Fi[j, i]) == 0:
                    ...
                    rr = 2 * (self.Fi0N - self.FiN(j, i)) / (self.FiN(j, i) - self.Fi[j, i]) #verified
            else:
                if (self.FiN(j, i) - self.Fi[j, i]) == 0:
                    return 0.0
                else:
            ...
            #rsm = (FiN - FiP) / (FiP - FiS)
            if j == 0 :
                if (self.Fi[j, i] - self.Fi0S) == 0:
                    return 0
                else:
                    rr = (self.FiN(j, i) - self.Fi[j, i]) / (2 * (self.Fi[j, i] - self.Fi0S)) #verified 
            elif j == self.Ny - 1:
                if (self.Fi[j, i] - self.FiS(j, i)) == 0:
                    return 0.0
                else:
                    rr = 2 * (self.Fi0N - self.Fi[j, i]) / (self.Fi[j, i] - self.FiS(j, i)) #verified
            else:
                if (self.Fi[j, i] - self.FiS(j, i)) == 0:
                    return 0.0
                else:
